...
var vjs = function(id, options, ready){
  ...
  if (!tag || !tag.nodeName) { // re: nodeName, could be a box div also
    throw new TypeError('组件或ID无效'); // Returns
  }
...
vjs.options = {
  ...
  'notSupportedMessage': 'Sorry!没有找到该视频的兼容.'
};
...
vjs.MediaError.defaultMessages = {
  1: 'Sorry!你放弃的视频播放',
  2: 'Sorry!网络错误导致的视频下载失败.',
  3: 'Sorry!视频播放是由于中止到出现问题，或者是因为您的浏览器不支持视频功能。',
  4: 'Sorry!视频无法加载，可能因为该服务器网络故障或不支持的格式。',
  5: 'Sorry!视频被加密和我们没有对其进行解密的密钥。'
};
